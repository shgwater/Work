...
group by user_id 
    ...
    select 
        ...
        ,case when DATEDIFF(day,a.create_date,a.payment_date) = 0 then '0天' 
        	...
        	when DATEDIFF(day,a.create_date,a.payment_date) >=31 and DATEDIFF(day,a.create_date,a.payment_date) <=60 then '13-60天'
		...
		,case when DATEDIFF(day,a.create_date,a.contract_date) >= 0 and DATEDIFF(day,a.create_date,a.contract_date) <=7 then '0-7天'
			...
			when DATEDIFF(day,a.create_date,a.contract_date) >=31 and DATEDIFF(day,a.create_date,a.contract_date) <=60 then '13-60天'
